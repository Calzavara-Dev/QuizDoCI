...
export const odometrosP2RapidasQuestions: Question[] = [
  {
    ...
    "options": [
      "Desligar a alimentação principal e usar proteção ESD.",
    ...
    "answer": "Desligar a alimentação principal e usar proteção ESD.",
  ...
  {
    "question": "Que cuidado mecânico e ambiental é obrigatório para preservar o equipamento?",
    "options": [
      "Alinhar nas guias deslizantes e fechar a tampa hermeticamente.",
    ...
    "answer": "Alinhar nas guias deslizantes e fechar a tampa hermeticamente.",
  ...
  {
    "question": "Como é a construção da S.D.T.U. no Odômetro AGI-LOG?",
    "options": [
      "Caixa de alumínio à prova d'água com conceito 100% modular (cartões e backplane).",
    ...
    "answer": "Caixa de alumínio à prova d'água com conceito 100% modular (cartões e backplane).",
  ...
  },
  {
    ...
    "options": [
      "Inferior a 15 a 30 minutos na substituição do módulo.",
    ...
    "answer": "Inferior a 15 a 30 minutos na substituição do módulo.",
  ...
  {
    "question": "Qual é o propósito fundamental da S.D.T.U. no sistema do Odômetro AGI-LOG?",
    "options": [
      "Explicitar, processar e exibir velocidade/distância, distribuindo sinais aos repetidores.",
    ...
    "answer": "Explicitar, processar e exibir velocidade/distância, distribuindo sinais aos repetidores.",
  ...
  },
  {
    ...
    "options": [
      "Medir velocidade na água (STW), totalizar distância em milhas e fornecer dados à navegação.",
    ...
    "answer": "Medir velocidade na água (STW), totalizar distância em milhas e fornecer dados à navegação.",
  ...
  {
    "question": "De quantas partes constituintes principais compõe-se o sistema completo do Odômetro AGI-LOG?",
    "options": [
      "3 partes: S.D.T.U., Conjunto do Sensor e Repetidores/Periféricos.",
    ...
    "answer": "3 partes: S.D.T.U., Conjunto do Sensor e Repetidores/Periféricos.",
  ...
  {
    "question": "Aonde e com qual finalidade operacional é empregada a Haste Retrátil (Retrátil) do Odômetro AGI-LOG?",
    "options": [
    ...
    "explanation": "A Haste Retrátil é montada dentro de um conjunto com válvula de fundo (sea valve / sluice valve).  Ela permite que a tripulação recolha a haste para dentro do casco ou a remova inteiramente para limpeza de cracas ou substituição sem que o navio precise ir para o dique seco (docagem).",
    "topic": "Aplicação da Haste Retrátil - AGI-LOG"
  },
  {
    "question": "Aonde é empregada preferencialmente a Haste Fixa (estilo OTAN) do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Aonde e por que é empregada a Haste com Perfil de Barbatana (Barbatana) do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Aonde é empregado o Sensor Revés (Revés) do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Quais são as seleções e funções que operam a tecla PROBE (Sensor)?",
    "options": [
  ...
  {
    "question": "Qual é a função do regulador de intensidade luminosa denominado DIMMER localizado no painel frontal da S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  },
  {
    ...
    "explanation": "Para a partida segura do sistema AGI-LOG, o técnico/operador primeiro garante a segurança física da haste submersa.  Em seguida, aciona a chave principal da S.D.T.U.",
  ...
  {
    "question": "Como se estrutura e como funciona o Circuito de Teste Integrado (BIT/BITE) localizado na S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "O que caracteriza e como é realizada a Manutenção por Diagnóstico em Nível Baixo (Nível Baixo) no Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "O que caracteriza e em que consiste a Manutenção por Diagnóstico em Nível Alto (Nível Alto) no Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Qual é a função central desempenhada pelo Módulo 02 (Microprocessador) na S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "No Módulo 02, qual é a função e o papel da Memória EPROM (EPROM)?",
    "options": [
  ...
  {
    "question": "No Módulo 02, qual é a função específica da Memória RAM (RAM)?",
    "options": [
  ...
  {
    "question": "Qual é a função desempenhada pelo Módulo 03 (Interface com Painel) na S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Na S.D.T.U., qual é a função essencial do Módulo 04 (Conversor A/D)?",
    "options": [
  ...
  {
    "question": "Qual é a função e a aplicação dos Módulos 05 e 06 (Conversores D/A) na S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Na S.D.T.U., qual é a função primordial e crítica do Módulo 07 (Saída Auxiliar)?",
    "options": [
  ...
  {
    "question": "Qual é a dupla função técnica exercida pelo Módulo 08 (Fonte de Alimentação) na S.D.T.U. do Odômetro AGI-LOG?",
    "options": [
  ...
  {
    "question": "Na verificação de segurança, que outro procedimento comutado é essencial?",
    "options": [
  ...
  },
  {
    ...
    "explanation": "A caixa de alumínio robusta do AGI-LOG possui classificação naval de vedação.  Se o anel de vedação (gasket) ficar mordido, ressecado ou sujo ao fechar a tampa, a maresia e umidade penetrarão rapidamente no chassi.",
  ...
  {
    "question": "No caso de utilização da Haste Retrátil (Retrátil) no Odômetro AGI-LOG, como o conjunto mecânico garante a segurança da embarcação durante a operação de recolhimento no mar?",
    "options": [
  ...
  {
    "question": "Por que a Haste Fixa (estilo OTAN) é construída de acordo com normas e flanges padronizados pelas especificações militares da OTAN?",
    "options": [
  ...
  {
    "question": "Qual é o fenômeno físico hidrodinâmico adverso que a Haste com Perfil de Barbatana (Barbatana) foi projetada para minimizar em embarcações de alta velocidade?",
    "options": [
  ...
  {
    "question": "Na partida, qual é a verificação física fundamental e prioritária antes do acionamento da chave principal?",
    "options": [
  ...
  },
  {
    ...
    "explanation": "O Módulo 07 (Saída Auxiliar / Pulsada) é a grande interface de saídas discretas do AGI-LOG.  Além de enviar trens de pulsos de distância que fazem avançar contadores mecânicos ou sistemas eletrônicos em cada fração de milha navegada, ele incorpora os relés de vigilância de alarme (`FAIL ALARM`).",
  ...
  {
    "question": "Qual é o tempo de reparo médio (MTTR)?",
    "options": [
      "30 minutos",
      "2 horas",
      "10 minutos",
  ...
  {
    "question": "Qual é a função do Módulo 02 (Microprocessador) do Odômetro AGI-LOG?",
    "options": [

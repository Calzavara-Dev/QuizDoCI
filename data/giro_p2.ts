...
export const giroP2Questions: Question[] = [
  {
    ...
    explanation: "O coração do sistema é uma unidade de medição inercial que funciona em uma configuração conhecida como 'Strap down'. Para detectar qualquer mudança de atitude ou aceleração no espaço tridimensional, ele utiliza exatamente três anéis de giro a laser (Ring Laser Gyros), dispostos de forma a criar um triedro ortogonal, e três acelerômetros que possuem seus eixos de sensibilidade posicionados paralelamente aos eixos de leitura dos giros."
  },
  {
  ...
  },
  {
    ...
    explanation: "A malha principal de potência do MK-39 opera nativamente em Corrente Contínua (VCD). Sua tensão de trabalho nominal esperada é entre 24 e 28 VCD, possuindo uma larga janela de segurança eletrônica que lhe permite sustentar operação contínua mesmo se a tensão variar na faixa de 18 a 36 VCD."
  },
  {
  ...
  },
  {
    ...
    explanation: "A chapa defletora frontal de metal robusto que encerra a ECU atua apenas como uma vitrine de comandos diretos puramente físicos para as malhas vitais de força."
  },
  {
    ...
    explanation: "Localizado no ventre oculto do módulo eletrônico, escondido estrategicamente do alcance casual humano pelas proteções metálicas frontais do painel da ECU, reside uma esteira contínua e vazada referida sob a alcunha militar de 'A2' (Rack dos Cartões)."
  },
  {
    ...
    explanation: "Dentre a contagem metódica e linear de posições numeradas dos encaixes lógicos no barramento do rack, o cartão encravado na terceira fenda e identificado no esquema elétrico simplesmente como 'A3' representa isoladamente o 'cérebro' do arranjo – o Processador Central (CPU)."
  },
  {
  ...
  },
  {
    ...
    explanation: "A caixa densa e escura no patamar inferior, ou Unidade de Medição Inercial (IMU), é responsável física e taticamente pela detecção da própria existência da embarcação no planeta, sem a qual os cérebros digitais não possuem o que ler."
  },
  {
  ...
  },
  {
    ...
    explanation: "Espelhando o papel do led parceiro para o caso de diagnóstico trágico, a sinalização luminosa dedicada instalada defronte à parte direita da Unidade Mestra atua em casos extremos sob a nomenclatura rígida referida localmente como DS2."
  },
  {
  ...
  },
  {
    ...
    explanation: "A lógica primária e inviolável da arquitetura eletrônica militar repassa sempre prioridade máxima e irrestrita à unidade central na casa das máquinas (INS). Qualquer movimentação despretensiosa do comando do botão liga-desliga na tela tática remota do display (RCDU) será ignorada pelo hardware, já sobrecarregado intencionalmente na condição vital independente ligada a força bruta de baixo."
  },
  {
  ...
  },
  {
    ...
    explanation: "O display em sua tela limpa e rápida logo após subir possui um menu isolado na janela a de base para conforto: Se houver muito sol a tela de cristal precisa de Invert Video, se for noite precisa de Back Light e se a buzina estiver perturbando ela pode ser desligada (ON/OFF)."
  },
  {
  ...
  },
  {
    ...
    explanation: "Diferentemente das placas do rack da ECU que admitem limpezas fáceis com ar comprimido, a Unidade de Medição Inercial (IMU) é concebida como um item hermético monolítico selado sem conserto mecânico autorizado no navio."
  },
  {
